...
swiftc -O -target arm64-apple-macosx13.0 -o "$APP/Contents/MacOS/$BIN" \
    main.swift HermesLaunch.swift QuickChat.swift ChatView.swift UsageDashboard.swift MenuBarStyleSettings.swift ScheduledTasks.swift SessionsBrowser.swift LogViewer.swift SkillsBrowser.swift \
    -framework Cocoa
